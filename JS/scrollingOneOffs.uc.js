...
// one-off search engine buttons to the right side of the url bar when the user
// is typing into the url bar. The script allows the search one-offs box to be
// scrolled with mousewheel up/down. It also adds a minor improvement to the
// one-offs in the searchbar results popup: if the one-offs are overflowing and
// you switch to a search engine that is overflown off the popup, it will
// automatically scroll to the selected one-off button, just like the urlbar
// one-offs does with oneClickOneOffSearchButtons.uc.js.
